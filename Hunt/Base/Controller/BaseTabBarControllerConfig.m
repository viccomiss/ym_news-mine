...
- (NSArray *)viewControllers {
    ...
    BaseInformationViewController *infomationVC = [[BaseInformationViewController alloc] init];
    BaseNavigationController *infomationNav = [[BaseNavigationController alloc] initWithRootViewController:infomationVC];
    
    
    MineViewController *mineVC = [[MineViewController alloc] init];
    BaseNavigationController *mineNav = [[BaseNavigationController alloc] initWithRootViewController:mineVC];
    
//    if ([[[[SEUserDefaults shareInstance] getOtaRestricted] jk_stringForKey:@"ota"] isEqualToString:@"0"]) {
...
- (NSArray *)tabBarItemsAttributesForController {
    ...
    NSDictionary *sixthTabBarItemsAttributes = @{
                                                 CYLTabBarItemTitle : Infomation,
                                                 CYLTabBarItemImage : @"tab_news",
                                                 CYLTabBarItemSelectedImage :@"tab_news_on",
                                                 };
...
#warning CUSTOMIZE YOUR TABBAR APPEARANCE
    ...
    // 自定义 TabBar 高度
    tabBarController.tabBarHeight = CYLTabBarControllerHeight + TabbarNSH;
    
    // set the text color for unselected state
    // 普通状态下的文字属性
    NSMutableDictionary *normalAttrs = [NSMutableDictionary dictionary];
    normalAttrs[NSForegroundColorAttributeName] = TextDarkColor;
    
    // set the text color for selected state
    // 选中状态下的文字属性
    NSMutableDictionary *selectedAttrs = [NSMutableDictionary dictionary];
    selectedAttrs[NSForegroundColorAttributeName] = PYTHEME_THEME_COLOR;
...
//    [tabBar setTitleTextAttributes:selectedAttrs forState:UIControlStateSelected];
    [tabBar py_addToThemeColorPoolWithSelector:@selector(setTitleTextAttributes:forState:) objects:@[selectedAttrs, @(UIControlStateSelected)]];
    ...
    [[UITabBar appearance] setBackgroundColor:WhiteTextColor];
