...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView{
    if ([self.delegate respondsToSelector:@selector(mainTableViewBeginScroll:)]) {
        [self.delegate mainTableViewBeginScroll:scrollView];
    }
}

- (void)scrollViewDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate{
    if ([self.delegate respondsToSelector:@selector(mainTableViewEndScroll:)]) {
        [self.delegate mainTableViewEndScroll:scrollView];
    }
}
